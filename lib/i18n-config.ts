...
'referral.description': 'Invite friends and earn coins',
...
'referral.step2': 'Friends sign up using your link',
'referral.step3': 'They make their first bet',
'referral.step4': 'You both receive bonus coins',
...
'referral.description': 'Приглашайте друзей и получайте монеты',
...
'referral.step1': 'Поделитесь своей уникальной ссылкой с друзьями',
'referral.step2': 'Друзья регистрируются по вашей ссылке',
'referral.step3': 'Они делают свою первую ставку',
'referral.step4': 'Вы оба получаете бонусные монеты',
