        ...
        <Card className="bg-gray-900 text-white border-gray-800">
          <CardHeader className="border-b border-gray-800">
            <CardTitle className="text-lg flex items-center">
              ...
              {t("profile.account") || "Account actions"}
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-6 space-y-4">
            <div>
              <Button 
                ...
                className="w-full border-gray-700 bg-gray-800 text-white hover:bg-gray-700 hover:text-red-400"
              >
                ...
                <AlertDialogContent className="bg-gray-900 text-white border-gray-700">
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-gray-300">
                      {t("profile.delete_warning") || "Are you sure? This action cannot be undone and you'll lost all your earnings"}
